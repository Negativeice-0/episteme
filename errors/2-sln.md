  ...
  return (
    <div className="space-y-16">
      ...
      <section className="text-center py-12 px-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#fff9e6] to-white -z-10" />
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-6">
          <span className="bg-gradient-to-r from-[#ffb347] to-[#ffd700] bg-clip-text text-transparent">
            AI frees students
          </span>
          <br />
        ...
        <div className="flex gap-4 justify-center">
          ...
          <Link
            href="/socratic"
            className="px-8 py-3 bg-gradient-to-r from-[#ffb347] to-[#ffd700] text-[#0a1929] rounded-lg hover:shadow-lg transition-all font-semibold"
          >
            Explore Prompts
          </Link>
        </div>
        ...
        {/* Animated Gold Bar */}
        <div className="w-24 h-1 bg-gradient-to-r from-[#ffb347] to-[#ffd700] mx-auto mt-12 rounded-full animate-pulse" />
      </section>
      ...
      <section className="max-w-3xl mx-auto">
        <div className="bg-gray-50 p-8 rounded-xl border-l-4 border-[#ffb347]">
          <p className="text-lg italic text-[#0a1929] flex items-start gap-4">
            <AcademicCapIcon className="w-8 h-8 text-[#ffb347] flex-shrink-0" />
            <span>
      ...
      <section className="grid md:grid-cols-3 gap-8">
        {[
          ...
          >
            <div className="w-12 h-12 bg-gradient-to-br from-[#ffb34720] to-[#ffd70020] rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
...
@layer base {
  ...
  h1, h2, h3, h4, h5, h6 {
    @apply font-semibold text-[#0a1929];
  }
}
...
@layer components {
  ...
  .gold-gradient {
    @apply bg-gradient-to-r from-[#ffb347] to-[#ffd700];
  }
  
  .gold-text {
    @apply bg-gradient-to-r from-[#ffb347] to-[#ffd700] bg-clip-text text-transparent;
  }
}
